  ...
  return (
    <Layout>
      ...
      >
        ...
        >
          <Stack direction={'column'} spacing={{ base: 3, lg: 6 }}>
            <p>
              In traditional name systems like DNS and ENS, names serve as
              unique IDs for websites or blockchain addresses. Woolball takes
            ...
            <p>
              ...
              social dependencies within the Web3 ecosystem. When two entities
              are linked, they are essentially establishing a relationship with
              each other. This allows for the development of new applications
              and use cases that rely on evaluating the relationships and
              reputations of entities within the system.
            </p>
            <p>
              For example, a social dApp built on top of Woolball could use
              links to evaluate the trustworthiness of strangers, or to filter
              out potential scams or malicious actors.
            </p>
            <p>
            ...
            <p>
              ...
              opens up exciting possibilities for the future of decentralized
          ...
          <Stack direction={'column'} spacing={{ base: 3, lg: 6 }}>
            ...
            <Stack direction={'column'}>
              <p>
                Woolball use cases are mostly based on ongoing interactions
                between entities within the Web3 ecosystem.
              </p>
              <p>
                One potential use case is the creation of a reputation system.
                With Woolball, entities can be assigned a reputation score based
                on the number and quality of links they have with other
                entities. This could be used to develop spam filters or social
                credit systems, allowing users to easily evaluate the
                trustworthiness of others within the system.
              </p>
              <p>
                Another use case is the implementation of a Woolball-based
                contract between DAOs or projects. In this scenario, each link
                represents a contractual agreement between two entities, and the
                link properties and functions specify the content of the
                agreement and its enforcement rules.
              </p>
              <p>
                ...
                links collateralized by yield farming links from a different
                app, opening app opportunities for complex DeFi apps.
              </p>
              <p>
                ...
                platform to track and manage their usage data.
              </p>
            </Stack>
          </Stack>
          <Stack direction={'column'} spacing={{ base: 3, lg: 6 }}>
            ...
            <Stack direction={'column'}>
              <p>
                Woolball is being built as we talk. We are a team of around 10
                people working on it hard.
              </p>
              <Stack direction={'column'} spacing={1}>
                <p>Currently we are:</p>
                <UnorderedList>
                  <ListItem ml={{ base: 4, lg: 7 }}>
                    Writing specs, this includes a proposal for an ERC a yellow
                    paper,
                  </ListItem>
                  <ListItem ml={{ base: 4, lg: 7 }}>
          ...
          <Stack direction={'row'}>
            <Link href={DISCORD_LINK} textDecoration={'underline'}>
              Join our Discord
            </Link>
            <Text>to be part of it!</Text>
          </Stack>
        </Stack>
      </Stack>
    </Layout>
